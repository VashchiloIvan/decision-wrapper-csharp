...
public class MethodResult : global::System.IDisposable {
  ...
  public MethodResult(MathModel first, SolveStatus second) : this(libdesPINVOKE.new_MethodResult__SWIG_1(MathModel.getCPtr(first), SolveStatus.getCPtr(second)), true) {
  ...
  public MathModel first {
    set {
      libdesPINVOKE.MethodResult_first_set(swigCPtr, MathModel.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = libdesPINVOKE.MethodResult_first_get(swigCPtr);
      MathModel ret = (cPtr == global::System.IntPtr.Zero) ? null : new MathModel(cPtr, false);
      return ret;
    } 
  }

  public SolveStatus second {
    set {
      libdesPINVOKE.MethodResult_second_set(swigCPtr, SolveStatus.getCPtr(value));
    } 
    get {
