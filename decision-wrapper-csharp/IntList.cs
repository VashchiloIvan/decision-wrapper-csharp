...
public class IntList : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<int>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libdesPINVOKE.delete_IntList(swigCPtr);
        }
  ...
  public IntList() : this(libdesPINVOKE.new_IntList__SWIG_0(), true) {
  }

  public IntList(IntList other) : this(libdesPINVOKE.new_IntList__SWIG_1(IntList.getCPtr(other)), true) {
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Clear() {
    libdesPINVOKE.IntList_Clear(swigCPtr);
  }

  public void Add(int x) {
    libdesPINVOKE.IntList_Add(swigCPtr, x);
  }

  private uint size() {
    uint ret = libdesPINVOKE.IntList_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = libdesPINVOKE.IntList_empty(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = libdesPINVOKE.IntList_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    libdesPINVOKE.IntList_reserve(swigCPtr, n);
  }

  public IntList(int capacity) : this(libdesPINVOKE.new_IntList__SWIG_2(capacity), true) {
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  private int getitemcopy(int index) {
    int ret = libdesPINVOKE.IntList_getitemcopy(swigCPtr, index);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private int getitem(int index) {
    int ret = libdesPINVOKE.IntList_getitem(swigCPtr, index);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, int val) {
    libdesPINVOKE.IntList_setitem(swigCPtr, index, val);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(IntList values) {
    libdesPINVOKE.IntList_AddRange(swigCPtr, IntList.getCPtr(values));
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public IntList GetRange(int index, int count) {
    global::System.IntPtr cPtr = libdesPINVOKE.IntList_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, int x) {
    libdesPINVOKE.IntList_Insert(swigCPtr, index, x);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, IntList values) {
    libdesPINVOKE.IntList_InsertRange(swigCPtr, index, IntList.getCPtr(values));
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    libdesPINVOKE.IntList_RemoveAt(swigCPtr, index);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    libdesPINVOKE.IntList_RemoveRange(swigCPtr, index, count);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public static IntList Repeat(int value, int count) {
    global::System.IntPtr cPtr = libdesPINVOKE.IntList_Repeat(value, count);
    IntList ret = (cPtr == global::System.IntPtr.Zero) ? null : new IntList(cPtr, true);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    libdesPINVOKE.IntList_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    libdesPINVOKE.IntList_Reverse__SWIG_1(swigCPtr, index, count);
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, IntList values) {
    libdesPINVOKE.IntList_SetRange(swigCPtr, index, IntList.getCPtr(values));
    if (libdesPINVOKE.SWIGPendingException.Pending) throw libdesPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Contains(int value) {
    bool ret = libdesPINVOKE.IntList_Contains(swigCPtr, value);
    return ret;
  }

  public int IndexOf(int value) {
    int ret = libdesPINVOKE.IntList_IndexOf(swigCPtr, value);
    return ret;
  }

  public int LastIndexOf(int value) {
    int ret = libdesPINVOKE.IntList_LastIndexOf(swigCPtr, value);
    return ret;
  }
